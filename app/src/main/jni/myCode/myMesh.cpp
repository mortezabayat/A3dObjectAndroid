...
MyMesh::MyMesh() : vbo_vertices(0), vbo_normals(0), ibo_elements(0),
 ...
 * Draw the object
 */
void MyMesh::draw(GLint attribute_v_coord, GLint attribute_v_normal, GLint uniform_m,
    ...
    glUniformMatrix4fv(uniform_m, 1, GL_FALSE, (const GLfloat *) mvpMat);
    /* Transform normal vectors with transpose of inverse of upper left
       3x3 model matrix (ex-gl_NormalMatrix): */
    /* glm::mat3 m_3x3_inv_transp = glm::transpose(glm::inverse(this->object2world));
 ...
 */
void MyMesh::draw_bbox(GLuint attribute_v_coord) {
    if (this->vertices.size() == 0)
        return;
