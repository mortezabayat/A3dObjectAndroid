...
Java_com_example_javan_demoobj_GestureClass_DoubleTapNative(JNIEnv *env, jobject instance) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_javan_demoobj_GestureClass_ScrollNative(JNIEnv *env, jobject instance,
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_javan_demoobj_GestureClass_ScaleNative(JNIEnv *env, jobject instance,
                                                              jfloat scaleFactor) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_javan_demoobj_GestureClass_MoveNative(JNIEnv *env, jobject instance,
                                                               jfloat distanceX, jfloat distanceY) {
